#It is important to note that myFile above is the "field name" within the multipart/form-data request payload.
#  https://github.com/karatelabs/karate/blob/master/karate-demo/src/test/java/demo/upload/upload.feature
